...
public class Candidatelogin_success extends JFrame implements database, ActionListener{
    ...
    Candidatelogin_success(String username){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Candidate-Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 216, 230)));
