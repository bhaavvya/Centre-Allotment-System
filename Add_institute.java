...
public class Add_institute extends JFrame implements ActionListener{
    ...
    Add_institute(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Add Institutes", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 216, 230)));
