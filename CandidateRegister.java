...
public class CandidateRegister extends JFrame implements ActionListener{
    ...
    CandidateRegister(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Register-Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 216, 230)));
