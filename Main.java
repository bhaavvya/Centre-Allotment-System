...
class Home extends JFrame implements ActionListener{
    ...
    Home(){
        ...
        panel1.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Home Page", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 216, 230)));
...
class AdminLogin extends JFrame implements ActionListener{
    static String Admin_username="a";
    ...
    AdminLogin(){
        ...
        panel.setBorder(new TitledBorder(new LineBorder(new Color(173, 216, 230), 2), "Admin Account", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(172, 216, 230)));
...
class Admin_success extends JFrame implements ActionListener {
    ...
    Admin_success(){//constructor for login frame
        ...
        super("LOGIN");//super must be the first line in the constructor
